  ...
  _create(props) {
    ...
    this.set({
      schema: {
        ...
        fields: [
          {
            // What type of button will this be?
            name: 'type',
    ...
    // Whatever props got passed in on _create, we pass along here
    // plus extra props in the second parameter `{ block: false, out: false }`
