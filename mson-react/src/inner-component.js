...
export default class InnerComponent extends React.PureComponent {
  ...
  render() {
    ...
    if (component) {
      const Component = componentUtils.getUIComponent(component); // QUESTION: Is this pulling the REACT component? I think so
      const retval = <Component component={component} {...others} />;
      // QUESTION: Can we put a hook here for a custom renderer?
      return retval;
    } else {
      return null;
    }
