...
import FormCard from '../form-card-dictionary-entry';
...
// hoping to be able to override the css globally
//
...
//import '../demo/styles.css'; // The easy way... but class names will be different in production
...
// QUESTION: Now... how do we get styles onto the App component?
// The app component is not in-scope.
// We could set a prop somewhere or make a function so that
// if the path is at a particular place, we change the style...
// would require overriding styles defined in App.js
...
class DictionaryEntryCollectionField extends React.PureComponent {
  state = {
  ...
  handleCancel = form => {
    ...
    if (component.get('skipRead')) {
      ...
      //component.set({ currentForm: form, mode: 'null' });
    }
  };
...
DictionaryEntryCollectionField = withStyles(styles, { withTheme: true })(
  DictionaryEntryCollectionField
);
DictionaryEntryCollectionField = attach([
  'change',
  'label',
  'singularLabel',
  'forbidCreate',
...
export default DictionaryEntryCollectionField;
