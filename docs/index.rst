...
For now though, there is some "coding" involved, if you want to call it that. To define the structure of
your app, you have to create what is called a MSON component definition. For instance, the definition for
a simple to-do list app would look like this:
